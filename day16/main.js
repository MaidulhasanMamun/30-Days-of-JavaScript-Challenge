...
//json file has keys and value pairs like object, but keys are in double quotes

//converting JSON to a javascript object
//when we want to convert a JSON file into an object we use json.parse()
//when we want to convert an object into a JSON file we use json.stringify()
...
//as said JSON format is string only
...
const usersText = `{
    ...
    const users = {
      ...
      const jsonTxt = JSON.stringify(users, undefined, 4);
      console.log(jsonTxt);
